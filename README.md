...
If you have any ideas what I missed, suggestions would be highly appreceated.

### Compatibility
* Unreal Engine 4.27
* C++20 is required to build game module. Corresponding UBT files for UE4 can be found [here](https://github.com/dimkKy/UBT4-CPP20/releases/tag/1.0)
